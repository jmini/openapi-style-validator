...
class ValidatorParametersTest {
    ...
    void testAllGetterSetters() {
        ...
        parameters.setPathNamingConvension(ValidatorParameters.NamingConvention.CamelCase);
        parameters.setParameterNamingConvension(ValidatorParameters.NamingConvention.CamelCase);
